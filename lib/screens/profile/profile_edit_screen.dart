...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  // 当前日期和时间
  final DateTime _now = DateTime.utc(2025, 5, 6, 5, 52, 14);
  ...
  Future<void> _loadUserProfile() async {
    ...
    try {
      ...
      _locationController.text = _userProfile?.additionalInfo?['location'] ?? "";
    } catch (e) {
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: _userProfile?.coverImageUrl != null
                ? DecorationImage(
          ...
          child: _userProfile?.coverImageUrl == null
              ? Center(
                  child: Icon(
                    Icons.image,
                    size: 40,
          ...
          child: Container(
            ...
            child: IconButton(
              ...
              onPressed: () {
                // 更换封面图片
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('封面图片更换功能开发中...')),
                );
              },
            ),
          ),
      ...
      child: Center(
        child: Column(
          children: [
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        // 更换头像
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('头像更换功能开发中...')),
                        );
                      },
                    ),
                  ),
            ...
            SizedBox(height: 16),
            Text(
              '上次更新时间: ${_formatDateTime(_now)}', // 使用当前时间
              style: TextStyle(
